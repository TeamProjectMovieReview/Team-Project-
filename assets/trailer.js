...
$(document).ready(function() {
  ...
  $('.movie-title-button').on('click', function() {
        let movieTitle = $(this).data('movie-title'); // Use the data attribute for the movie title
        const apiKey = 'AIzaSyDPU8IN-u247_xtIkgR5GdC_5ByMJiXW2w'; // Your YouTube API key
